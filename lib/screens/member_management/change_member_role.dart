...
class ChangeMemberRolePage extends StatefulWidget {
  const ChangeMemberRolePage({super.key});

  @override
  State<ChangeMemberRolePage> createState() => _ChangeMemberRolePageState();
}

class _ChangeMemberRolePageState extends State<ChangeMemberRolePage> {
  ...
  String _normalizeDesignation(String designation) {
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Skeletonizer(
                  ...
                  child: _buildDesignationFilterChips(
                    provider,
                    screenWidth,
                    isTablet,
                  ),
  ...
  Widget _buildDesignationFilterChips(
    ...
    return ListView.builder(
      ...
      itemCount: provider.availableDesignations.length,
      itemBuilder: (context, index) {
        final designation = provider.availableDesignations[index];
        final isSelected = provider.selectedFilter == designation;
        ...
        return Container(
          ...
          child: FilterChip(
            ...
            selected: isSelected,
            onSelected: (selected) {
              provider.updateFilter(designation);
            },
  ...
  Widget _buildMembersList(
    ...
    final designations = ['Member', 'ASCO', 'Coordinator', 'Lead', 'Admin'];
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final rawDesignation = member['designation'] ?? 'Member';
        final currentDesignation = _normalizeDesignation(rawDesignation);
        final updatedDesignation =
            provider.memberUpdates[memberId] ?? currentDesignation;
                        ...
                        child: DropdownButton<String>(
                          ...
                          onChanged: (newDesignation) {
                            if (newDesignation != null &&
                              ...
                              provider.updateMemberField(
                                memberId,
                                newDesignation,
                              );
                            } else if (newDesignation == currentDesignation &&
  ...
  Future<void> _handleSubmit(
    ...
    final success = await provider.submitDesignationUpdates();

    _showResultModal(
      context,
      success,
      successMessage: 'Member roles updated successfully!',
      errorMessage: provider.error ?? 'Failed to update member roles',
    );
  }
