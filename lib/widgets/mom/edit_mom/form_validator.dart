...
class FormDataUtils {
  ...
  static Set<String> initializeDomains(
    ...
    for (final initialDomain in domainsToProcess) {
      final matchingDomain = findMatchingDomain(
        initialDomain,
        availableDomains,
      );
