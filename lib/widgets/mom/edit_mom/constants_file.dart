...
class AppConstants {
  ...
  static const List<String> defaultDomains = ['Operations', 'Marketing', 'Content'];
}
...
class AppDimensions {
  ...
  // Button dimensions
  static const EdgeInsets buttonPadding = EdgeInsets.symmetric(horizontal: 40, vertical: 16);
